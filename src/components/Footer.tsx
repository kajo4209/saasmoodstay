...
const socials = [
  { icon: <FbIcon />, href: "#", color: "#4FC3F7" },
  { icon: <InstaIcon />, href: "#", color: "#4FC3F7" },
  { icon: <TikTokIcon />, href: "#", color: "#4FC3F7" },
  { icon: <WaIcon />, href: "https://wa.me/201201543050", color: "#25D366" },
];
...
export function Footer() {
  ...
  const links = [
    ...
    { href: "#contact", label: null, sub: t.nav.bookNow },
  ];
    ...
    <footer className="bg-gray-950 text-gray-300 py-16 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          {/* Links */}
          <div>
            <h4 className="font-black text-white mb-4">{tr(t.footer.links, lang)}</h4>
            <ul className="space-y-2 text-sm">
              {navLinkItems.map((l, i) => (
                <li key={i}>
                  <a href={l.href} className="text-gray-400 hover:text-sky-400 transition-colors">
                    {tr(l.label, lang)}
                  </a>
                </li>
              ))}
          ...
          {/* Contact */}
          <div>
            <h4 className="font-black text-white mb-4">{tr(t.footer.contact, lang)}</h4>
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-2 text-gray-400">
                <span className="text-sky-400"><PinIcon /></span>
                {tr(t.footer.addr, lang)}
              </div>
            </div>
          </div>
        </div>
